# -*- coding: utf-8 -*-
"""AdvaitGhatge_McDonald'sCaseStudy.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1BQ5Pcex_PmTX_LeWZpJej-UFSSGyGc1a
"""
...
"""**11 variables (columns) have yes or no values.**"""
...
#Checking for the count of variables
...
"""**We observe that there are more female customers than their male counterparts.**"""
...
"""**People between the ages of 31-36 and 48-60 visit McDonald's more often than the people in other age groups.**"""

#Customer segmentation - based on pyschographic segmentation

#For convenience we are renaming the category
df['Like']= df['Like'].replace({'I hate it!-5': '-5','I love it!+5':'+5'})
#Like 
sns.catplot(x="Like", y="Age",data=df, 
            orient="v", height=5, aspect=2, palette="Set2",kind="swarm")
plt.title('Distribution of customers w.r.t Age')
plt.show()
